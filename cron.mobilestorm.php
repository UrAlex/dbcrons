...
$tcle = 0;
$cad = "";
$createtstamp = strtotime("$today");
$createtstamp2 = time();
echo $createtstamp."<br>";
echo $createtstamp2."<br>";
$campaigns = Blasts::get_blasts("email", $createtstamp, $createtstamp2);
print_r($campaigns);

for($i=1; $i<=$campaigns[0]['total']; $i++)
{
	...
	$updatequery = "update NEWSLETTERblasts set lasttimeupdate='$dateaction', timesupdate='1' where aliencampaingid='$messageid'";
	update($updatequery);
}
...
$ttcl = $tcle + $tcli + $tclu;
$ttu = $tue + $tui + $tuu;
$date1 = date("Y-m-d H:i:s", $createtstamp);
$date2 = date("Y-m-d H:i:s", $createtstamp2);
$header = "$date1 to $date2\n\n";
$header .= "Total: $ttotal\n";
